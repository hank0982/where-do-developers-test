...
def add_args(parser):
    ...
    parser.add_argument("--only_model", action='store_true',
                        help="Whether to run test only by model component.")
    ...
    # 新加的参数
    parser.add_argument("--top_k", default="", type=int,
                help="")
    parser.add_argument("--projects_dir", default="", type=str,
            help="")
    parser.add_argument("--eval_all_projects", action='store_true',
            help="")
    parser.add_argument("--checkpoints_dir", default="", type=str,
            help="")
    parser.add_argument("--inference_only", action='store_true',
            help="Run recommendation output only without requiring labels or computing evaluation metrics.")
